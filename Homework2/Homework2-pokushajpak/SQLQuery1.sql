...
SELECT * FROM Student WHERE FirstName LIKE 'Antonio'
...
SELECT * FROM Teacher JOIN Student ON Teacher.ID = Student.ID
WHERE Teacher.LastName LIKE Student.LastName


SELECT * FROM Grade JOIN Teacher ON Grade.ID = TeacherID WHERE Grade IS NULL

SELECT * FROM Course JOIN AchievementType ON Course.ID = AchievementType.ID 
JOIN Grade ON Course.ID = Grade.ID
